...
background = SlidingImage('images/background_temp.png',(0,-50),-40,.75)
floor = SlidingImage('images/floor_temp.png',(0,670),-145,.7)
...
while True:
    ...
    dt = float(clock.tick(60))/1000.0  # limits FPS to 60 and assigns a 0 to 1 value to dt